        ...
        <View style={styles.heroTop}>
          ...
          <View style={styles.chips}>
            <View style={styles.chip}>
              <DeltaText delta={today.salesHero.day} compact />
            </View>
            <View style={styles.chip}>
              <DeltaText delta={today.salesHero.week} compact />
            </View>
            <View style={styles.chip}>
              <DeltaText delta={today.salesHero.month} compact />
            </View>
          </View>
        </View>
        <Text style={typeScale.kpi}>{today.salesHero.value}</Text>
