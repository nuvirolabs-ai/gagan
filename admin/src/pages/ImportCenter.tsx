  ...
  return <div className="import-center">
    ...
    <div className="import-layout">
      ...
      <main className="import-workspace">{selected ? <>
        ...
        {selected.type === "products" && <p className="muted">New products and packs stay pending review. Existing active rows cannot be changed here. Use product_id and variant_id for draft edits; count-only packs require an explicit weight.</p>}
