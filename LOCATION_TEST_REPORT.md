...
- Full backend regression on disposable PostgreSQL `gagan_location_test3_20260821` with mock SAP/OTP/payment: **279 passed** across 78 files.
...
- Direct database-backed flow: capture → verify → server-side verified check-in → checkout completed, with two immutable history rows.
