  ...
  return (
    <View style={styles.screen}>
      <View style={styles.card}>
        ...
        <TouchableOpacity style={styles.continue} onPress={() => void continueToApp()} disabled={saving}>
...
const styles = StyleSheet.create({
  ...
  logo: { color: colors.green, fontSize: 26, fontWeight: "800", letterSpacing: 2, textAlign: "center", marginBottom: spacing.xl },
  ...
  continue: { backgroundColor: colors.greenDeep, borderRadius: radius.md, paddingVertical: 15, alignItems: "center", marginTop: spacing.xl },
